...
public class _3DObjectFollowCursorLynxMotion : MonoBehaviour
{
    ...
    private float _bodyAOffset = 0f;
    private float _bodyBOffset = -80f;
    private float _bodyCOffset = 60f;
    private float _bodyDOffset = 20f;
    ...
    void UpdateRealRobotJoints()
    {
        ...
        _sliderA.value = Mathf.DeltaAngle(0, _shadowA.transform.localEulerAngles.y) + _bodyAOffset;
        ...
        _sliderB.value = Mathf.DeltaAngle(0, _shadowB.transform.localEulerAngles.y) + _bodyBOffset;
        ...
        _sliderC.value = Mathf.DeltaAngle(0, _shadowC.transform.localEulerAngles.y) + _bodyCOffset;
        ...
        _sliderD.value = Mathf.DeltaAngle(0, _shadowD.transform.localEulerAngles.y) + _bodyDOffset;
        //Debug.Log("Rotations: " + _shadowA.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyA.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowB.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyB.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowC.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyC.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowD.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyD.transform.localEulerAngles.y.ToString("#.##0") + ".");
    }
    #endregion
}