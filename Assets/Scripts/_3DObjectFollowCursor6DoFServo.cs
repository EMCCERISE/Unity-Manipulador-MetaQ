...
public class _3DObjectFollowCursor6DoFServo : MonoBehaviour
{
    ...
    [SerializeField] public GameObject _shadowGripL;
    [SerializeField] public GameObject _shadowGripR;
    ...
    [SerializeField] private float _bodyEOffset = 00f;
    ...
    void Update()
    {
        ...
        if (_buttonActive.activeInHierarchy.Equals(true) & !EventSystem.current.IsPointerOverGameObject() & (Input.GetMouseButton(0) | Input.GetKey(KeyCode.Q).Equals(true)) & (Time.time - _lastUpdate > _updateInterval) & (Time.time - _mouseDownTimer > 0.15f))
        {
            ...
            if (_gripL.transform.localEulerAngles.x != _shadowGripL.transform.localEulerAngles.x)
            {
                _shadowGripL.transform.DOLocalRotate(_gripL.transform.localEulerAngles, 0.5f);
            }
            if (_gripR.transform.localEulerAngles.x != _shadowGripR.transform.localEulerAngles.x)
            {
                _shadowGripR.transform.DOLocalRotate(_gripR.transform.localEulerAngles, 0.5f);
            }
    ...
    void UpdateRealRobotJoints()
    {
        ...
        Debug.Log("A- Calc:" + (_bodyAMult * (Mathf.DeltaAngle(0, _shadowA.transform.localEulerAngles.y) + _bodyAOffset)).ToString("#.##0") + "/Ins:" + ((GetInspectorRotation(_shadowA.transform).y)).ToString("#.##0") + "/Ang:" + (_shadowA.transform.localEulerAngles.y).ToString("#.##0"));
        //#if UNITY_ANDROID || UNITY_WEBGL
#if true
        _sliderA.value = _bodyAMult * (Mathf.DeltaAngle(0, _shadowA.transform.localEulerAngles.y) + _bodyAOffset);
        _sliderB.value = _bodyBMult * (Mathf.DeltaAngle(0, _shadowB.transform.localEulerAngles.z) + _bodyBOffset);
        _sliderC.value = _bodyCMult * (Mathf.DeltaAngle(0, _shadowC.transform.localEulerAngles.z) + _bodyCOffset);
        _sliderD.value = _bodyDMult * (Mathf.DeltaAngle(0, _shadowD.transform.localEulerAngles.z) + _bodyDOffset);
        _sliderE.value = _bodyEMult * (Mathf.DeltaAngle(0, _shadowGripL.transform.localEulerAngles.y) + _bodyEOffset);
        _sliderF.value = _bodyFMult * (Mathf.DeltaAngle(0, _shadowGripR.transform.localEulerAngles.y) + _bodyFOffset);
#else
        _sliderA.value = _bodyAMult * (GetInspectorRotation(_shadowA.transform).y + _bodyAOffset);
        _sliderB.value = _bodyBMult * (GetInspectorRotation(_shadowB.transform).z + _bodyBOffset);
        _sliderC.value = _bodyCMult * (GetInspectorRotation(_shadowC.transform).z + _bodyCOffset);
        _sliderD.value = _bodyDMult * (GetInspectorRotation(_shadowD.transform).z + _bodyDOffset);
        _sliderE.value = _bodyEMult * (GetInspectorRotation(_shadowGripL.transform).y + _bodyEOffset);
        _sliderF.value = _bodyFMult * (GetInspectorRotation(_shadowGripR.transform).y + _bodyFOffset);
#endif
        //_sliderA.value = _bodyAMult * (GetInspectorRotation(_shadowA.transform).y + _bodyAOffset);
       ...
       // _sliderB.value = _bodyBMult * (GetInspectorRotation(_shadowB.transform).x + _bodyBOffset);
        ...
        //Debug.Log("Rotations: " + _shadowA.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyA.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowB.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyB.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowC.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyC.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowD.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyD.transform.localEulerAngles.y.ToString("#.##0") + ".");
       // _sliderE.value = _bodyEMult * (GetInspectorRotation(_shadowGripL.transform).x + _bodyEOffset);
        //Debug.Log("E: " + (_bodyEMult * (Mathf.DeltaAngle(0, _shadowGripL.transform.localEulerAngles.x) + _bodyEOffset)).ToString("#.##0"));
        //Debug.Log("Rotations: " + _shadowA.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyA.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowB.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyB.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowC.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyC.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowD.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyD.transform.localEulerAngles.y.ToString("#.##0") + ".");
       // _sliderF.value = _bodyFMult * (GetInspectorRotation(_shadowGripR.transform).y + _bodyFOffset);
        //Debug.Log("F: " + (_bodyFMult * (Mathf.DeltaAngle(0, _shadowGripR.transform.localEulerAngles.y) + _bodyFOffset)).ToString("#.##0"));
        //Debug.Log("Rotations: " + _shadowA.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyA.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowB.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyB.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowC.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyC.transform.localEulerAngles.y.ToString("#.##0") + ", " + _shadowD.transform.localEulerAngles.y.ToString("#.##0") + "/" + _bodyD.transform.localEulerAngles.y.ToString("#.##0") + ".");
    }
#endregion
